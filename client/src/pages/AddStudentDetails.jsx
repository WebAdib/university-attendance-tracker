...
const AddStudentDetails = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (!fullName || !email || !phoneNumber || !enrollmentYear || !guardianContact || !department) {
            setError('All fields are required');
            return;
        }

        try {
            const response = await api.post('/students/details', {
                fullName,
                email,
                phoneNumber,
                enrollmentYear: parseInt(enrollmentYear),
                guardianContact,
                department, // Include department in the submission
            }, {
                headers: { Authorization: `Bearer ${getAuthToken()}` },
            });
            ...
            setError(err.response?.data?.message || 'Failed to add student details');
    ...
    return (
        <div className="flex h-screen bg-gray-100">
            ...
            <div className="flex-1 p-8 overflow-auto">
                <h1 className="text-3xl font-bold mb-6 text-gray-800">Add Student Details</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                placeholder="Enter enrollment year (e.g., 2023)"
                                required
                            />
                        </div>
                        <div>
