...
import { FaUsers, FaPlus, FaTrash, FaBuilding, FaBookOpen, FaBell, FaClipboardList, FaChalkboardTeacher, FaClipboardCheck, FaUserGraduate } from 'react-icons/fa';
        ...
        <div className="flex h-screen bg-gray-100">
            ...
            <div className="flex-1 p-8 overflow-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <a
                        href="/admin-panel/student-status"
                        className="bg-white p-6 rounded-xl shadow-md flex items-center space-x-4 transform transition-all duration-300 hover:shadow-lg hover:bg-blue-50"
                    >
                        <FaUserGraduate className="text-4xl text-purple-600" />
                        <div>
                            <h2 className="text-xl font-semibold text-gray-800">Student Status</h2>
                            <p className="text-gray-600">Manage student courses and payments</p>
                        </div>
                    </a>
                    <a
